 ...
 */
    ...
    private static String url_all_products = "url du script";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                // à compléter
            	// un intent vers la bière selectionnée
            }
        });
 
    }
 
    // Méthode lancée en cas d'erreur sur la page.
    @Override
    ...
    class LoadAllProducts extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            //todo marche pas
            JSONObject json = new JSONObject();// = (jParser) makeHttpRequest(url_all_products, "GET", params);
